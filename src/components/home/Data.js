  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Hello! Welcome to my website. My name is Chiemela, I am a full stack developer and U.S Army
        veteran. I am proficient with the MERN stack,
        but also, I learn different technologies to broaden my skill set.
